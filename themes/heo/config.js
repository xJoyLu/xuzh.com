const CONFIG = {
  ...
  SITE_CREATE_TIME: '2023-08-08', // 建站日期，用于计算网站运行的第几天

  // 首页顶部通知条滚动内容，如不需要可以留空 []
  NOTICE_BAR: [
    { title: '欢迎来到「序章」OPEN 天地', url: 'https://open.xuzh.com' },
    { title: '访问官网了解我们的产品', url: 'https://xuzh.com' }
  ],

  // 英雄区(首页顶部大卡)
  HERO_TITLE_1: '凡是过去',
  HERO_TITLE_2: '皆为序章',
  HERO_TITLE_3: 'OPEN.XUZH.COM',
  HERO_TITLE_4: 'OPEN 上线',
  HERO_TITLE_5: '分享「序章」日常',
  HERO_TITLE_LINK: 'https://open.xuzh.com',
  ...
  INFO_CARD_URL: 'https://github.com/xjoylu', // 个人资料底部按钮链接
  ...
  SOCIAL_CARD_TITLE_2: '加入我们共建数字游民社群',
  SOCIAL_CARD_TITLE_3: '点击加入社群',
  SOCIAL_CARD_URL: 'https://xuzh.com/contacts.html',
